...
public class TutorDetailsModel {
    ...
    @SerializedName("fav_tutor")
    @Expose
    private String favTutor;
    @SerializedName("id")
    @Expose
    ...
    public String getFavTutor() {
        return this.favTutor;
    }

    public void setFavTutor(String favTutor2) {
        this.favTutor = favTutor2;
    }
}
