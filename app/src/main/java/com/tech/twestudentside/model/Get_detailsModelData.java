...
public class Get_detailsModelData {
    ...
    public void setTutorDetails(TutorDetailsModel tutorDetails2) {
    ...
    public Integer getTotalChargesIndividual() {
        return this.totalChargesIndividual;
    }

    public void setTotalChargesIndividual(Integer totalChargesIndividual2) {
        this.totalChargesIndividual = totalChargesIndividual2;
    }

    public Integer getTotalChargesGroup() {
        return this.totalChargesGroup;
    }

    public void setTotalChargesGroup(Integer totalChargesGroup2) {
        this.totalChargesGroup = totalChargesGroup2;
    }
